      ...
      <div className=''>
        ...
        <div className='flex flex-col-reverse lg:flex-row justify-between items-center gap-4 lg:px-20 px-5 py-10'>
          ...
          <div className='flex flex-wrap gap-2 lg:flex-nowrap'>
            <p className='glassmorphin p-1 px-2'>Automation</p>
            <p className='glassmorphin p-1 px-2'>Blockchain</p>
            <p className='glassmorphin p-1 px-2'>Frontend</p>
            <p className='glassmorphin p-1 px-2'>Backend</p>
            <p className='glassmorphin p-1 px-2'>AI</p>
          </div>
